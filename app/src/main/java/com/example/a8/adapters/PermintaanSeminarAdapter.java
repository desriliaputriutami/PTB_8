...
public class PermintaanSeminarAdapter extends RecyclerView.Adapter<PermintaanSeminarAdapter.MahasiswaViewHolder>{
    ...
    public PermintaanSeminarAdapter(ArrayList<PermintaanTA> listPermintaanTA) {
